...
^($PMMtQJOcHm8eFQfdsdNAS20->()&0xDEAD));};'42';($vgOjwRk4wIo7=MainWindow->new)->title($r);
($vMnyQdAkfgIIik = $vgOjwRk4wIo7->Canvas("-$a"=>640,"-$b"=>480,"-$u"=>$f))->pack;@p=(42,42
);$cqI=$vMnyQdAkfgIIik->createLine(@p,@p,"-$y"=>$c,"-$a"=>3);;;$S9cXJIGB0BWce=0;$_2kY10=0;
$_8NZQooI5K4b=0;$Sk6lA7p0=0;$MMM__;$_=M(120812).'/'.M(191323).M(133418).M(98813).M(112412)
...
$cqI||$S9cXJIGB0BWce>44)&&$i->cancel();});$KEY=5;$vgOjwRk4wIo7->bind("<$Sk61A7pO-n>"=>sub{
$Sk6lA7p0=1;});$vgOjwRk4wIo7->bind("<$Sk61A7pO-m>"=>sub{$Sk6lA7p0=-1;});$vgOjwRk4wIo7#%&*"
->bind("<$sk6i47pO-n>"=>sub{$Sk6lA7p0=0 if $Sk6lA7p0>0;});$vgOjwRk4wIo7->bind("<$sk6i47pO"
